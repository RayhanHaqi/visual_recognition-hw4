...
python train_hw4.py --gpu_ids 1 --epochs 150 --precision 32 --batch_size 4
...
python train_hw4.py --gpu_ids 1 --epochs "$BEST_EPOCH" --merge_val --no_val --precision 32 --batch_size 4 --lr 5e-5
