...
12 & p256, L1+MSE ($\lambda$=0.10) & 139 & original / TTA / avg5 TTA & 31.31 / 31.72 / 31.72 \\ \bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
    \item Even stronger MSE weighting ($\lambda = 0.20$) was not tested; $\lambda = 0.10$ was worse than 0.05.
